...
extension WindowLayoutFeatureStrings {
    static let ko = WindowLayoutFeatureStrings(
        ...
        centerThird: "가운데 삼등분",
        rightThird: "오른쪽 삼등분",
        leftTwoThirds: "왼쪽 삼분의 이",
        rightTwoThirds: "오른쪽 삼분의 이",
        topThird: "위쪽 삼등분",
        middleThird: "가운데 삼등분",
        bottomThird: "아래쪽 삼등분",
        topTwoThirds: "위쪽 삼분의 이",
        bottomTwoThirds: "아래쪽 삼분의 이",
        topQuarter: "위쪽 사등분",
        secondTopQuarter: "위에서 두 번째 사등분",
        thirdTopQuarter: "위에서 세 번째 사등분",
        bottomQuarter: "아래쪽 사등분",
...
struct WindowLayoutFeatureStrings {
    ...
    let secondTopQuarter: String
    let thirdTopQuarter: String
    ...
    static let enUS = WindowLayoutFeatureStrings(
        ...
        secondTopQuarter: "Second top quarter",
        thirdTopQuarter: "Third top quarter",
    ...
    static let ptBR = WindowLayoutFeatureStrings(
        ...
        leftThird: "Terço esquerdo",
        centerThird: "Terço central",
        rightThird: "Terço direito",
        leftTwoThirds: "Dois terços à esquerda",
        rightTwoThirds: "Dois terços à direita",
        topThird: "Terço superior",
        middleThird: "Terço do meio",
        bottomThird: "Terço inferior",
        topTwoThirds: "Dois terços superiores",
        bottomTwoThirds: "Dois terços inferiores",
        topQuarter: "Quarto superior",
        secondTopQuarter: "Segundo quarto do topo",
        thirdTopQuarter: "Terceiro quarto do topo",
        bottomQuarter: "Quarto inferior",
    ...
    static let tr = WindowLayoutFeatureStrings(
        ...
        leftThird: "Sol üçte bir",
        centerThird: "Orta üçte bir",
        rightThird: "Sağ üçte bir",
        leftTwoThirds: "Sol üçte iki",
        rightTwoThirds: "Sağ üçte iki",
        topThird: "Üst üçte bir",
        middleThird: "Orta üçte bir",
        bottomThird: "Alt üçte bir",
        topTwoThirds: "Üst üçte iki",
        bottomTwoThirds: "Alt üçte iki",
        topQuarter: "Üst çeyrek",
        secondTopQuarter: "Üstten ikinci çeyrek",
        thirdTopQuarter: "Üstten üçüncü çeyrek",
        bottomQuarter: "Alt çeyrek",
    ...
    static let ru = WindowLayoutFeatureStrings(
        ...
        leftThird: "Левая треть",
        centerThird: "Центральная треть",
        rightThird: "Правая треть",
        leftTwoThirds: "Левые две трети",
        rightTwoThirds: "Правые две трети",
        topThird: "Верхняя треть",
        middleThird: "Средняя треть",
        bottomThird: "Нижняя треть",
        topTwoThirds: "Верхние две трети",
        bottomTwoThirds: "Нижние две трети",
        topQuarter: "Верхняя четверть",
        secondTopQuarter: "Вторая сверху четверть",
        thirdTopQuarter: "Третья сверху четверть",
        bottomQuarter: "Нижняя четверть",
    ...
    static let es = WindowLayoutFeatureStrings(
        ...
        leftThird: "Tercio izquierdo",
        centerThird: "Tercio central",
        rightThird: "Tercio derecho",
        leftTwoThirds: "Dos tercios a la izquierda",
        rightTwoThirds: "Dos tercios a la derecha",
        topThird: "Tercio superior",
        middleThird: "Tercio medio",
        bottomThird: "Tercio inferior",
        topTwoThirds: "Dos tercios superiores",
        bottomTwoThirds: "Dos tercios inferiores",
        topQuarter: "Cuarto superior",
        secondTopQuarter: "Segundo cuarto desde arriba",
        thirdTopQuarter: "Tercer cuarto desde arriba",
        bottomQuarter: "Cuarto inferior",
    ...
    static let de = WindowLayoutFeatureStrings(
        ...
        leftThird: "Linkes Drittel",
        centerThird: "Mittleres Drittel",
        rightThird: "Rechtes Drittel",
        leftTwoThirds: "Linke zwei Drittel",
        rightTwoThirds: "Rechte zwei Drittel",
        topThird: "Oberes Drittel",
        middleThird: "Mittleres Drittel",
        bottomThird: "Unteres Drittel",
        topTwoThirds: "Obere zwei Drittel",
        bottomTwoThirds: "Untere zwei Drittel",
        topQuarter: "Oberes Viertel",
        secondTopQuarter: "Zweites Viertel von oben",
        thirdTopQuarter: "Drittes Viertel von oben",
        bottomQuarter: "Unteres Viertel",
    ...
    static let fr = WindowLayoutFeatureStrings(
        ...
        leftThird: "Tiers gauche",
        centerThird: "Tiers central",
        rightThird: "Tiers droit",
        leftTwoThirds: "Deux tiers gauches",
        rightTwoThirds: "Deux tiers droits",
        topThird: "Tiers haut",
        middleThird: "Tiers milieu",
        bottomThird: "Tiers bas",
        topTwoThirds: "Deux tiers hauts",
        bottomTwoThirds: "Deux tiers bas",
        topQuarter: "Quart haut",
        secondTopQuarter: "Deuxième quart depuis le haut",
        thirdTopQuarter: "Troisième quart depuis le haut",
        bottomQuarter: "Quart bas",
    ...
    static let it = WindowLayoutFeatureStrings(
        ...
        centerThird: "Terzo centrale",
        rightThird: "Terzo destro",
        leftTwoThirds: "Due terzi a sinistra",
        rightTwoThirds: "Due terzi a destra",
        topThird: "Terzo alto",
        middleThird: "Terzo centrale",
        bottomThird: "Terzo basso",
        topTwoThirds: "Due terzi alti",
        bottomTwoThirds: "Due terzi bassi",
        topQuarter: "Quarto alto",
        secondTopQuarter: "Secondo quarto dall’alto",
        thirdTopQuarter: "Terzo quarto dall’alto",
        bottomQuarter: "Quarto basso",
    ...
    static let ja = WindowLayoutFeatureStrings(
        ...
        centerThird: "中央の三分割",
        rightThird: "右の三分割",
        leftTwoThirds: "左の三分の二",
        rightTwoThirds: "右の三分の二",
        topThird: "上の三分割",
        middleThird: "中央の三分割",
        bottomThird: "下の三分割",
        topTwoThirds: "上の三分の二",
        bottomTwoThirds: "下の三分の二",
        topQuarter: "上の四分割",
        secondTopQuarter: "上から2番目の四分割",
        thirdTopQuarter: "上から3番目の四分割",
        bottomQuarter: "下の四分割",
        topLeftSixth: "左上 1/6",
    ...
    static let zhHans = WindowLayoutFeatureStrings(
        ...
        centerThird: "中三分",
        rightThird: "右三分",
        leftTwoThirds: "左侧三分之二",
        rightTwoThirds: "右侧三分之二",
        topThird: "上三分",
        middleThird: "中三分",
        bottomThird: "下三分",
        topTwoThirds: "上三分之二",
        bottomTwoThirds: "下三分之二",
        topQuarter: "上四分",
        secondTopQuarter: "上数第二四分",
        thirdTopQuarter: "上数第三四分",
        bottomQuarter: "下四分",
        topLeftSixth: "左上 1/6",
    ...
    static let zhTW = WindowLayoutFeatureStrings(
        ...
        centerThird: "中間三分",
        rightThird: "右側三分",
        leftTwoThirds: "左側三分之二",
        rightTwoThirds: "右側三分之二",
        topThird: "上三分",
        middleThird: "中三分",
        bottomThird: "下三分",
        topTwoThirds: "上三分之二",
        bottomTwoThirds: "下三分之二",
        topQuarter: "上四分",
        secondTopQuarter: "上數第二四分",
        thirdTopQuarter: "上數第三四分",
        bottomQuarter: "下四分",
        topLeftSixth: "左上 1/6",
