...
extension WindowLayoutFeatureStrings {
    static let ko = WindowLayoutFeatureStrings(
        ...
        topQuarter: "위쪽 1/4",
        secondTopQuarter: "위에서 두 번째 1/4",
        thirdTopQuarter: "위에서 세 번째 1/4",
...
struct WindowLayoutFeatureStrings {
    ...
    static let enUS = WindowLayoutFeatureStrings(
        ...
        topQuarter: "Top 1/4",
        secondTopQuarter: "Second top 1/4",
        thirdTopQuarter: "Third top 1/4",
    ...
    static let ptBR = WindowLayoutFeatureStrings(
        ...
        topQuarter: "Topo 1/4",
        secondTopQuarter: "Segundo do topo 1/4",
        thirdTopQuarter: "Terceiro do topo 1/4",
    ...
    static let tr = WindowLayoutFeatureStrings(
        ...
        topQuarter: "Üst 1/4",
        secondTopQuarter: "Üstten ikinci 1/4",
        thirdTopQuarter: "Üstten üçüncü 1/4",
    ...
    static let ru = WindowLayoutFeatureStrings(
        ...
        secondTopQuarter: "Вторая сверху 1/4",
        thirdTopQuarter: "Третья сверху 1/4",
    ...
    static let es = WindowLayoutFeatureStrings(
        ...
        secondTopQuarter: "Segundo desde arriba 1/4",
        thirdTopQuarter: "Tercero desde arriba 1/4",
    ...
    static let de = WindowLayoutFeatureStrings(
        ...
        topQuarter: "Oben 1/4",
        secondTopQuarter: "Zweites von oben 1/4",
        thirdTopQuarter: "Drittes von oben 1/4",
    ...
    static let fr = WindowLayoutFeatureStrings(
        ...
        topQuarter: "Haut 1/4",
        secondTopQuarter: "2e depuis le haut 1/4",
        thirdTopQuarter: "3e depuis le haut 1/4",
    ...
    static let it = WindowLayoutFeatureStrings(
        ...
        topQuarter: "Alto 1/4",
        secondTopQuarter: "Secondo dall’alto 1/4",
        thirdTopQuarter: "Terzo dall’alto 1/4",
    ...
    static let ja = WindowLayoutFeatureStrings(
        ...
        topQuarter: "上 1/4",
        secondTopQuarter: "上から2番目 1/4",
        thirdTopQuarter: "上から3番目 1/4",
        bottomQuarter: "下 1/4",
        topLeftSixth: "左上 1/6",
    ...
    static let zhHans = WindowLayoutFeatureStrings(
        ...
        bottomTwoThirds: "下 2/3",
        topQuarter: "上 1/4",
        secondTopQuarter: "上二 1/4",
        thirdTopQuarter: "上三 1/4",
        bottomQuarter: "下 1/4",
        topLeftSixth: "左上 1/6",
